...
class ItinerariesControllerTest < ActionController::TestCase
  ...
  test "should create itinerary" do
    assert_difference('Itinerary.count') do
      post :create, itinerary: { day: @itinerary.day, description: @itinerary.description, tour_id: @itinerary.tour_id }
    end
  ...
  test "should update itinerary" do
    patch :update, id: @itinerary, itinerary: { day: @itinerary.day, description: @itinerary.description, tour_id: @itinerary.tour_id }
    assert_redirected_to itinerary_path(assigns(:itinerary))
  end
